...
class LaporanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('laporan.index', compact('transaksis', 'units', 'tglAwal', 'tglAkhir', 'kodeUnit', 'totalDebit', 'totalKredit', 'selisih'));
    }
  ...
  public function exportPdf(Request $request)
{
    ...
    // 1. Hitung Saldo Awal murni sebelum tanggal filter
    ...
    // 2. Jika saldo awal sebelum periode = 0, ambil nominal dari transaksi 'SALDO AWAL' pertama di periode ini
    ...
    $pdf = Pdf::loadView('laporan.pdf', compact('transaksis', 'tglAwal', 'tglAkhir', 'kodeUnit','saldoAwal', 'saldoAwalHeader', 'totalDebit', 'totalKredit', 'saldoAkhir'))
